...
read1 = read.csv(file="./data/vk.csv", header = TRUE,sep = ",")
...
url_gsheet = "https://docs.google.com/spreadsheets/d/1aQVkiQfVtNFudXXu6-uYmf9h6WV83y8b4FN1pLd1c_g/edit?usp=sharing"
df_gsheet = as.data.frame(gsheet2tbl(url_gsheet))
head(df_gsheet)
df_gsheet
